...
public abstract class SqlSessionDaoSupport extends DaoSupport {
     ...
     * <p>
     * <b>Note: The returned SqlSessionTemplate is a shared instance.</b> You may introspect its configuration, but not modify the configuration (other than from within an {@link #initDao} implementation). Consider creating a custom SqlSessionTemplate
     * instance via {@code new SqlSessionTemplate(getSqlSessionFactory())}, in which case you're allowed to customize the settings on the resulting instance.
     *
